...
const data = {
  ...
  [LABEL.WRINKLE]: STATUS.CAUTION,
  [LABEL.PORE]: STATUS.WARNING,
  [LABEL.DRY]: STATUS.WARNING,
  [LABEL.ELASTIC]: STATUS.CLEAR,
};
    ...
    <S.Container>
      ...
      <S.Card>
        <S.SectionHeader>
          ...
          <S.DateButton>최근 진단일 | {new Date().toLocaleDateString()} | ▶</S.DateButton>
        </S.SectionHeader>

        <S.ChartAndLegend>
          <SkinRadarChart data={data} />
          <LabelSummary data={data} />
        </S.ChartAndLegend>
      </S.Card>
    </S.Container>
  );
