...
export default function AiValiditySection() {
  return (
    <S.Section as={motion.section} variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.3 }}>
      ...
      <S.BlockWrapper as={motion.div} variants={staggerContainer}>
        <motion.div variants={fadeInUp}>
          <S.Block>
            <S.RotatedImageBox>
        ...
        <motion.div variants={fadeInUp}>
          <S.Block>
            ...
            <S.Text>
              기존의 피부분석은 전문가와의 상담을 통해 얻을 수 있는 데이터를 필요로 했지만, AI는 전문가의 라벨링을 바탕으로 학습된 이미지 데이터를 기반으로 약
              20초 만에 결과를 도출할 수 있어, 시간과 비용 측면에서 매우 효율적입니다.
            </S.Text>
          </S.Block>
        </motion.div>
      </S.BlockWrapper>
